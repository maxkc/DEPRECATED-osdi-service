...
function sendSingleResourceResponse(resourcePromise, translator, resourceType, res) {
  resourcePromise.
    ...
    catch(ngpvanAPIClient.errors.NotFound, 
      function(ex) { return osdi.response.badRequest(res, resourceType)(ex); }).
    catch(ngpvanAPIClient.errors.Unexpected, 
      function (ex) { return osdi.response.badRequest(res, resourceType)(ex); });
}
 ...
 */
function sendMultiResourceResponse(resourcePromise, vanPaginationParams, translator,
 resourceType, res) {
  resourcePromise.
    then(function(vanResources) {
      ...
      var page = Math.floor(vanPaginationParams.skip / vanPaginationParams.top) + 1;
